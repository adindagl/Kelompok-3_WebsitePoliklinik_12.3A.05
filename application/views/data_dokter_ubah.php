<?php $res=$res->row_array() ?>
        ...
        <div class="container-fluid">
          ...
          <!-- DataTales Example -->
          <form method="post" action="<?php echo base_url() ?>web/data-dokter/perbarui">
          <div class="row">
                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control mr-2 d-none d-sm-inline-block" id="kode_dokter" name="kode_dokter"  value="<?php echo $res['kode_dokter'] ?>" readonly>
                      </div>
                      ...
                      <div class="input-group mb-3">
                        <input type="text" class="form-control d-none d-sm-inline-block" id="kode_poli" name="kode_poli" readonly value="<?php echo $res['kode_poli'] ?>">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control mr-2 d-none d-sm-inline-block" id="nama" name="nama"  value="<?php echo $res['nama_dokter'] ?>" required>
                      </div>
              
                      <div class="form-group">
                        <label for="sip">No. SIP (Surat Izin Praktek)</label>
                         <textarea class="form-control mr-2 d-none d-sm-inline-block" id="sip" name="sip"  required><?php echo $res['sip'] ?></textarea>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="text">No. Telepon</label>
                         <input type="text" class="form-control mr-2 d-none d-sm-inline-block" id="text" name="nomor_telepon"  value="<?php echo $res['nomor_telepon'] ?>" required>
                      </div>

                      <div class="form-group">
                        <label for="alamat_dokter">Alamat</label>
                         <textarea class="form-control mr-2 d-none d-sm-inline-block" id="alamat_dokter" name="alamat" required><?php echo $res['alamat'] ?></textarea>
                      </div>
