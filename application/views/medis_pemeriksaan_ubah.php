<?php $res=$res->row_array() ?>
        ...
        <div class="container-fluid">
          ...
          <!-- DataTales Example -->
          <form method="post" action="<?php echo base_url() ?>web/medis-periksa/perbarui">
          <div class="row">
                  ...
                  <div class="card-body">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control mr-2 d-none d-sm-inline-block" id="keluhan" name="keluhan" required ><?php echo $res['keluhan'] ?></textarea>
                      </div>

                      <div class="form-group">
                        <label for="diagnosa">Diagnosa</label>
                         <textarea class="form-control mr-2 d-none d-sm-inline-block" id="diagnosa" name="diagnosa" required><?php echo $res['diagnosa'] ?></textarea>
                      </div>
                     

                      <div class="form-group">
                         <button class="d-none d-sm-inline-block btn btn-md btn-primary shadow-sm" type="submit">Ubah Pemeriksaan</button>
