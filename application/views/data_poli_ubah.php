<?php $res=$res->row_array() ?>
        ...
        <div class="container-fluid">
          ...
          <!---->
          <!-- DataTales Example -->
          <form method="post" action="<?php echo base_url() ?>web/data-poli/perbarui">
          <div class="row">
                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control mr-2 d-none d-sm-inline-block" id="kode_poli" name="kode_poli"  value="<?php echo $res['kode_poli'] ?>" readonly>
                      </div>
                      
                      <div class="form-group">
                        <label for="nama_poli">Nama Poli</label>
                        <input type="text" class="form-control mr-2 d-none d-sm-inline-block" id="nama_poli" name="nama_poli"  value="<?php echo $res['nama_poli'] ?>" required>
                      </div>
                    
                       <div class="form-group">
                        <label for="lantai">Lantai</label>
                        <input type="number" class="form-control mr-2 d-none d-sm-inline-block" id="lantai" name="lantai"  value="<?php echo $res['lantai'] ?>" required>
                      </div>
