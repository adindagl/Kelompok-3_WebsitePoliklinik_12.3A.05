                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control mr-2 d-none d-sm-inline-block" id="nomor_pasien" name="nomor_pasien"  value="<?php echo $kode_pasien ?>" readonly>
                      </div>
                      
                      <div class="form-group">
                        <label for="nama">Nama Pasien</label>
                        <input type="text" class="form-control mr-2 d-none d-sm-inline-block" id="nama" name="nama_pasien"  value="" required>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="alamat_pasien">Alamat Pasien</label>
                         <textarea class="form-control mr-2 d-none d-sm-inline-block" id="alamat_pasien" name="alamat" value="" required></textarea>
                      </div>

                      <div class="form-group">
                        <label for="tl">Tanggal Lahir</label>
                         <input type="date" class="form-control mr-2 d-none d-sm-inline-block" id="tl" name="tanggal_lahir"  value="" required>
                      </div>

                       <div class="form-group">
                        <label for="usia">Usia</label>
                         <input type="number" class="form-control mr-2 d-none d-sm-inline-block" id="usia_pasien" name="usia"  value="" readonly>
                      </div>


                      <div class="form-group">
                         <label for="nomor_telepon">Nomor Telepon</label>
                         <input type="number" class="form-control mr-2 d-none d-sm-inline-block" id="nomor_telepon_pasien" name="nomor_telepon"  value="" required>
                      </div>
