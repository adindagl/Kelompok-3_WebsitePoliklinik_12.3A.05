<?php 
        $kode_tindakan = $auto->kode_max;
        $noUrut = (int) substr($kode_tindakan, 2, 3);
        $noUrut++;
        $char = "TN";
     ...
     ?>
        ...
        <div class="container-fluid">
          ...
          <!-- DataTales Example -->
          <form method="post" action="<?php echo base_url() ?>web/data-tindakan/simpan">
          <div class="row">
                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control mr-2 d-none d-sm-inline-block" id="kode_tindakan" name="kode_tindakan"  value="<?php echo $kode_tindakan ?>" readonly>
                      </div>
                      
                      <div class="form-group">
                        <label for="nama_tindakan">Nama Tindakan</label>
                        <input type="text" class="form-control mr-2 d-none d-sm-inline-block" id="nama_tindakan" name="nama_tindakan"  value="" required>
                      </div>
